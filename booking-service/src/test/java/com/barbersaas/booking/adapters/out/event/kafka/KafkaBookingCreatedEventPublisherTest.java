...
class KafkaBookingCreatedEventPublisherTest {

  @SuppressWarnings("unchecked")
  private final KafkaTemplate<String, String> kafkaTemplate = mock(KafkaTemplate.class);

  @Test
  void shouldPublishBookingCreatedEnvelopeToKafka() {
    MessagingProperties properties = new MessagingProperties();
    properties.setBookingCreatedKafkaTopic("booking-created-kafka");

    KafkaBookingCreatedEventPublisher publisher =
        new KafkaBookingCreatedEventPublisher(kafkaTemplate, properties);
